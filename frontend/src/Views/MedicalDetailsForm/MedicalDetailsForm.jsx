                ...
                {({ setFieldValue }) => (
                    <Form id="medicalForm">
                        <div className="history_data-form">
                            ...
                            {/* Pregnancy status input field */}
                            <div className="form_input-container">
                                <label htmlFor="pregnancyStatus">
                                    Pregnancy Status: Are you pregnant, planning to become
                                    pregnant?
                                </label>
                                <Input
                                    className="input-box"
                            ...
                            {/* Breastfeeding status input field */}
                            <div className="form_input-container">
                                <label htmlFor="breastfeedingStatus">
                                    Breastfeeding Status: Are you breastfeeding?
                                </label>
                                <Input
                                    className="input-box"
                                    type="text"
                                    ...
                                    onChange={(e) =>
                                        setFieldValue("breastfeedingStatus", e.target.value)
                                    }
                                />
                            </div>
                            <ErrorMessage
